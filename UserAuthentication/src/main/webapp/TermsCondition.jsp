...
<h1 style="text-align: center">Website terms and conditions by WebsitePolicies.com</h1>
<p>
Please read these terms and conditions ("terms and conditions", "terms") carefully
before using [website URL] website (“website”, "service") operated by [company name]
("us", 'we", "our").
...
this Agreement, you are advised to stop using the website accordingly. [company name]
...
legally adhere to this Agreement. [company name] assumes no responsibility for
...
You grant [company name] a royalty-free and non-exclusive license to display, use,
...
PRO TIP: Save your time and take the guess work out of the legal jargon with the
professional terms and conditions generator trusted by thousands of small
businesses. </p><br>
<a href="index.jsp" style="text-decoration: none;font-size:20px">Back</a>
</body>
</html>